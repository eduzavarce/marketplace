...
const insertRandomUsers = async () => {
  ...
  await pool.query(
    `INSERT INTO users (id, username , name,lastName,email,password,avatar,createdAt,verificationCode,role,verifiedAt,bio,region,country,type,taxNumber,address) VALUES (3,'cayetano',NULL,NULL,'cayetano.ponce.molina+2@gmail.com','$2b$10$adn8YnMXyuZWZjWmFT761u1k9UiLPOj2./MOi47vR2zcqlpiIJGf.','default-avatar.png','2023-05-09 18:28:35','lqhJvlVD2KWC0CGrPBTmNdGtca5aENB5rEYLf1GZ951U3zMfvbaJsi9wFE3VjdoX','user','2023-05-09 18:28:39',NULL,NULL,NULL,NULL,NULL,NULL);`
  );
  await pool.query(
